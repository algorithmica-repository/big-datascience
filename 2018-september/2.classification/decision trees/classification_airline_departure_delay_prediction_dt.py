...
pipeline = Pipeline(stages=imputer + encoder + assembler + [dt])
...
persist_model(cv_model, "dt", "/FileStore/tables/")

# COMMAND ----------

loaded_model = load_model("/FileStore/tables/cv_model_dt_10-06-2018-1538862687")
print(loaded_model)
